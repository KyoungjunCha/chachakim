...
import '../css/NoticeUpdatePage.css'; // 스타일을 위한 CSS 파일
...
const NoticeUpdatePage = () => {
    ...
    const handleSave = () => {
        ...
        axios.put(`http://localhost:4000/notices/${id}`, notice)
            .then(response => {
            ...
            <div className="update-notice-container">
                ...
                <div className="form-section">
                    ...
                    <div className="button-group">
                        ...
                        <button className="cancel-button" onClick={() => navigate("/noticePage")}>취소</button>
                    </div>
                </div>
            </div>
        </div>
